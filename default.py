...
def parseToolsTube(url):
    ...
    #var files = '{"240":"http:\/\/content.toolstube.com\/api\/files\/videos\/2015\/03\/21\/\/\/1426947624eb865-240.mp4"}
   ...
   for sourceVideo in sourceVideos:
      ...
      if 'facebook' in host:
         ...
         for video in sourceVideo:
          ...
          videoItem.append( (parseToolsTube(sourceVideo), sourceName, 'ToolsTube' ) )
